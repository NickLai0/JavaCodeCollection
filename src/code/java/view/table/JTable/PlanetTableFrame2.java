...
public class PlanetTableFrame2 extends JFrame {
    ...
    //因为Java Core 2里面的git图全部找不到，所以到网上下载一张Mercury.gif，全部都替换为这个图片。
    private Object[][] cells = {
            {"Mercury", 2440.0, 0, false, Color.YELLOW,
                    new ImageIcon(ProjectFileUtils.getImageAbsPathByName("Mercury.gif"))},
    ...
    public PlanetTableFrame2() {
        ...
        var filter = new RowFilter<TableModel, Integer>() {
            public boolean
            include(Entry<? extends TableModel, ? extends Integer> entry) {
